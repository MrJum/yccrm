<?php /* Smarty version 2.6.26, created on 2019-07-29 13:36:56
         compiled from crm/cst_dict_show.html */ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="ibox-content">
          <form id="pagerForm" method="post"  class="form-inline">
            <div class="col-sm-3 m-b-xs"> 
					 <a class="btn btn-info" href="<?php echo @ACT; ?>
/crm/CstDict/cst_dict_add/">添加数据</a>
...
?>
                  ...
                  <option value="<?php echo $this->_tpl_vars['v']['typetag']; ?>
" hassubinfo="true"><?php echo $this->_tpl_vars['v']['typename']; ?>
</option>
...
/crm/CstDict/cst_dict_modify/dict_id/<%=list[i]['dict_id']%>/">修改</a></li>
...
/index.php/crm/CstDict/cst_dict_json/';
...
/index.php/crm/CstDict/cst_dict_del/";
		}
...
/index.php/crm/CstDict/cst_dict_del/";
	...
	$("body").on("click", ".onoffswitch-checkbox", function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo @ACT; ?>
/index.php/crm/CstDict/cst_dict_modify_visible/",
	...
	$("body").on("blur", ".modify_sort", function() {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo @ACT; ?>
/index.php/crm/CstDict/cst_dict_modify_sort/",
	...
	$("body").on("blur", ".modify_name", function() {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo @ACT; ?>
/index.php/crm/CstDict/cst_dict_modify_name/",
