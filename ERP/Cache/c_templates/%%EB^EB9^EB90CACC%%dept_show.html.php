<?php /* Smarty version 2.6.26, created on 2019-07-29 13:34:55
...
/sysmanage/Dept/dept_modify/id/'+dept_id,
			...
			$.ajax({
				type: "POST",
				url: "<?php echo @ACT; ?>
/index.php/sysmanage/Dept/dept_del/",
				data:{"id":dept_id},
				dataType:"json",
	...
	$("body").on("blur", ".treeSort", function() {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo @ACT; ?>
/index.php/sysmanage/Dept/dept_modify_sort/",
	...
	$("body").on("blur", ".treeName", function() {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo @ACT; ?>
/index.php/sysmanage/Dept/dept_modify_name/",
