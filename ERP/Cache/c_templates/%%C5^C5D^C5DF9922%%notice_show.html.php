<?php /* Smarty version 2.6.26, created on 2019-07-29 13:36:58
...
/index.php/sysmanage/Notice/notice_del/";
			$.ajax({
				type: "POST",
				url: act_url,
			...
			act_url="<?php echo @ACT; ?>
/index.php/sysmanage/Notice/notice_read/";
			$.ajax({
				type: "POST",
				url: act_url,
				data:{"notice_id":notice_id_txt},
...
/index.php/sysmanage/Notice/notice_add/',
				end: function () {
					turnPage(1);
				}
			});			
			...
			layer.open({
				...
				area: ['90%', '90%'],
				content: '<?php echo @ACT; ?>
/index.php/sysmanage/Notice/notice_view/notice_id/'+notice_id+'/',
				end: function () {
					turnPage(1);
				}
			});			
