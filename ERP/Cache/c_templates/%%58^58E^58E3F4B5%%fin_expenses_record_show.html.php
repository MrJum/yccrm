<?php /* Smarty version 2.6.26, created on 2019-07-29 13:52:45
         compiled from erp/fin_expenses_record_show.html */ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5><i class="fa fa-home"></i> 其它费用支出列表</h5>
...
/index.php/erp/FinExpensesRecord/fin_expenses_record_json/';
...
/index.php/erp/FinExpensesRecord/fin_expenses_record_del/";
...
/index.php/erp/FinExpensesRecord/fin_expenses_record_add/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
