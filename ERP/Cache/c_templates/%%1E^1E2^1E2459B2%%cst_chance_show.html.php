<?php /* Smarty version 2.6.26, created on 2019-07-29 14:07:26
...
/index.php/crm/CstChance/cst_chance_json/';
...
/index.php/crm/CstChance/cst_chance_add/' //iframe的url
		});			
		return false;	
	});
...
/index.php/crm/CstChance/cst_chance_modify_recommend/";
		}else if(batch_act=="del"){
			act_url="<?php echo @ACT; ?>
/index.php/crm/CstChance/cst_chance_del/";
		}
	...
	$("body").on("click", ".single_operation", function() {
		...
		if(single_act=="add"){
			layer.open({
				...
				area: ['90%', '90%'],
				content: '<?php echo @ACT; ?>
/index.php/crm/CstChance/cst_chance_add/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
			...
			layer.open({
				...
				area: ['90%', '90%'],
				content: '<?php echo @ACT; ?>
/index.php/crm/CstChance/cst_chance_modify/chance_id/'+chance_id+'/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
